 ...
 * you can order in the link 
 https://vaksipranata.herokuapp.com/menus 
 and which you pavorite menus and click a menu on the list.
 ...
 * in the cart you can add condiments such us cream or gely.
 ...
 ## If your a admin 
 * you can admin access this web, so check this endpoint link 
 https://vaksipranata.herokuapp.com/admin
